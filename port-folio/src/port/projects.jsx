...
const Projects = () => {
  ...
  const proj_desc = [
    ...
    },
    {
      ...
      link: "https://victory-vault.vercel.app/",
    },
    {
      id: 3,
    ...
    <div className="main_proj_container pb-10">
      <div className="project_container">
        ...
        <div className="projects_have">
          <p>
            I have built interactive websites using modern frameworks,
      ...
      <motion.div style={{ y: yTransform }} className="projects_div">
        <div className="proj1_grid">all projects</div>
        <p className="eager">
          I am eager to learn, grow, and contribute effectively to help clients
          achieve their goals.
        </p>
        ...
        >
          ...
          >
            {descData.link && (
              ...
              className="absolute top-3 right-3 text-white hover:text-blue-400 transition hover:cursor-pointer"
            >
            ...
            <div style={{ width: "100%", height: "auto" }}>
              <div
                ...
                style={{ backgroundImage: `url(${descData.image})` }}
              ></div>
              <div className="desc_text">{descData.description}</div>
              <div className="desc_text">{descData.tech_stack}</div>
              <div className="desc_text">{descData.sample_credentials}</div>
            </div>
          </motion.div>
        </motion.div>
      )}
